                    ...
                    <div class="col-xl-3 col-md">
                        <div class="card bg-primary text-white mb-4 shadow-lg">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <h2 class="display-4 mt-2 font-weight-bold">{{count($validvisitor)}}</h2> <!-- Display the number here -->
                            </div>
                    ...
                    <div class="col-xl-3 col-md">
                        <div class="card bg-warning text-white mb-4 shadow-lg">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <h2 class="display-4 mt-2 font-weight-bold">{{$invalid}}</h2> <!-- Display the number here -->
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="/invalid">View Details</a>
                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl col-md">
                        <div class="card bg-success text-white mb-4 shadow-lg">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <h2 class="display-4 mt-2 font-weight-bold">{{$valid}}</h2> <!-- Display the number here -->
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="/valid">View Details</a>
                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            </div>
                        </div>
                    </div>
